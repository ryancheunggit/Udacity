...
var entourage = new (function() {
	...
	var whitelist = /\.7z$|\.asf$|\.asx$|\.avi$|\.bin$|\.csv$|\.doc$|\.exe$|\.flv$|\.gif$|\.gz$|\.gzip$|\.jar$|\.jpe?g$|\.js$|\.mp(2|3|4|e?g)$|\.mov(ie)?|\.msi$|\.msp$|\.pdf$|\.png$|\.ppt$|\.qtm?|\.ra(m|r)?|\.sea$|\.sit$|\.tar$|\.tgz$|\.txt$|\.wav$|\.wma$|\.wmv$|\.wpd$|\.xls$|\.xml$|\.z$|\.zip$|\.swf$|\.svg$|\.xlsx$|\.docx$|\.pptx$|\.rtf$|\.tif$|\.ico$|\.log$|\.db$|\.psd$|\.pps$|\.rm$|\.vob$|\.bmp$|\.tiff$|\.gpx$|\.kml$|\.kmz$|\.rss$|\.zipx$/i;
	...
	var autograph = function() {
		...
		_gaq.push(
			['_setAccount', 'UA-18660041-1'],
			["_trackEvent", "Downloads", fileName.split('.').pop().toUpperCase(), this.pathname],
			['ritaTracker._setAccount', 'UA-47993809-1'],
			["ritaTracker._trackEvent", "Downloads", fileName.split('.').pop().toUpperCase(), this.pathname]
		);
    };
...
// ------------------------ RITA CODE -------------------------
  ...
  var _gaq = _gaq || [];
  _gaq.push(['ritaTracker._setAccount', 'UA-47993809-1']);
  _gaq.push(['ritaTracker._trackPageview']);
...
// ------------------------ DOT CODE ------------------------
  ...
  _gaq.push(['_setDomainName', 'dot.gov']);
