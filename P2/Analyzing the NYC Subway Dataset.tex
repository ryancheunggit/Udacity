...
rather than normal distribution.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{grouped} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{day\PYZus{}week}\PY{l+s}{\PYZdq{}}\PY{p}{)}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} <matplotlib.axes.\_subplots.AxesSubplot at 0x142b3da0>
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analyzing the NYC Subway Dataset_files/Analyzing the NYC Subway Dataset_30_1.png}
    \end{center}
    { \hspace*{\fill} \\}
